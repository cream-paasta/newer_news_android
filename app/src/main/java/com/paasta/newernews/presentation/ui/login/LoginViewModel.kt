...
import com.paasta.newernews.domain.model.LoginUser
import com.paasta.newernews.domain.usecase.*
import com.paasta.newernews.domain.usecase.local.SetEmailUseCase
import com.paasta.newernews.domain.usecase.local.SetLoginUseCase
import com.paasta.newernews.domain.usecase.local.SetTokenUseCase
import com.paasta.newernews.domain.usecase.local.SetUserNameUseCase
...
class LoginViewModel @Inject constructor(
    ...
    fun requestLogin(email: String, pw: String) {
        postLoginUseCase.execute(Login(LoginUser( email, pw)))
